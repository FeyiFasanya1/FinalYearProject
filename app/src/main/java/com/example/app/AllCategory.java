...
import com.example.app.Adapter.AllCategoryAdapter;
import com.example.app.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.ic_fruits));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.ic_drink));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.ic_fish));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.ic_drink));
        ...
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.ic_fruits));
